...
const HeroSection = ({
  ...
  return (
    ...
    >
        ...
        {images.map((src, i) => (
          ...
          >
            <img
              ...
              decoding="async"
            />
            {/* Gray gradient overlay (left→right) + subtle multiply for depth */}
      ...
      {/* Content: left on lg+, full width on mobile */}
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-12 pt-24 sm:pt-28 md:pt-32 pb-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
          ...
          {/* Right half left empty to keep imagery visible */}
      ...
      {/* Subtle corner glows for polish */}
