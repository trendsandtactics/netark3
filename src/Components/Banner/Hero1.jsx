...
import { motion } from "framer-motion"; // remove this line if you don't want animations
import { Link } from "react-router-dom";
import ImageCarousel from "./ImageCarousel"; // make sure the path & casing match the file
