...
const Nav = ({ onNavigate }) => {
  ...
  return (
    <>
      ...
      {/* STYLES */}
      <style>{`
        /* ====== NAV: Transparent background, black text, ruby hover ====== */
        .main-nav {
          position: sticky;
          top: 0;
          background: transparent;      /* requested */
          border-bottom: none;          /* no divider */
        ...
        .main-nav a {
          ...
          font-weight: 600;
          font-size: 1rem;
          padding: 6px 2px;             /* tight, no pill bg */
          border-radius: 6px;
          transition: color .2s ease;
        }
        .main-nav a:hover { color: ${RUBY}; }  /* ruby on hover */
        .main-nav a:focus-visible {
          outline: 2px solid ${RUBY};
          outline-offset: 2px;
        }
