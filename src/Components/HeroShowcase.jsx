...
export default function HeroShowcase({
  ...
  return (
    <section
      ...
      style={{ backgroundColor: "#0b0f1a", contain: "paint layout" }}
    >
      ...
      <div className="absolute inset-0 -z-10">
        {images.map((src, i) => {
          ...
          return (
            <div
              key={`${src}-${i}`}
              className="absolute inset-0 transition-opacity ease-[cubic-bezier(.22,.61,.36,1)] duration-[1100ms] will-change-[opacity]"
              style={{
                opacity: visible ? 1 : 0,
            ...
            >
              <img
                ...
                draggable={false}
              />
              {/* Darken & left-to-right gradient for text legibility */}
      ...
      {/* === Content === */}
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-12 pt-24 sm:pt-28 md:pt-32 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
          ...
          {/* Empty right side to let background show like the reference design */}
